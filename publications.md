...
<div class="timeline">
  <div class="timeline-item">
    ...
    <div class="timeline-desc">Poster: Inferring a Collective Posterior Distribution from Highly Variable Experimental Replicates</div>
  </div>
  <div class="timeline-item">
    <div class="timeline-date">Sep 2024</div>
    <div class="timeline-title">ISEB, Hebrew University of Jerusalem</div>
    <div class="timeline-desc">Poster: The Collective Posterior Distribution and Its Application in SBI from Highly Variable Experimental Replicates</div>
  </div>
  <div class="timeline-item">
    <div class="timeline-date">Jun 2024</div>
    <div class="timeline-title">IDSAI</div>
    <div class="timeline-desc">Flash talk and poster: The Collective Posterior Distribution</div>
  </div>
  <div class="timeline-item">
    <div class="timeline-date">May 2024</div>
    <div class="timeline-title">IBS, Ben Gurion University</div>
    <div class="timeline-desc">Poster: SBI from Experimental Replicates using the Collective Posterior and Marginal Likelihood</div>
  </div>
  <div class="timeline-item">
    <div class="timeline-date">Feb 2024</div>
    <div class="timeline-title">GSI, Weizmann Institute</div>
    <div class="timeline-desc">Poster: Discovering the dominant genomic components in CNV formation</div>
  </div>
  <div class="timeline-item">
    <div class="timeline-date">Jun 2023</div>
    <div class="timeline-title">Safra Center Retreat, Ginossar</div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-title">ISEB, Haifa University</div>
    <div class="timeline-desc">Poster: Inference of CNV rate and fitness effect from yeast evolutionary experiments</div>
  </div>
</div>
